...
public class BlockRenderContext {
    ...
    public void update(BlockPos pos, BlockPos origin, BlockState state, BakedModel model, long seed, ModelData modelData, RenderLayer layer) {
        this.pos.set(pos);
    ...
    /**
     * @return The extra data of the model
     */
    ...
    /**
     * @return The rendering layer of the model
     */
